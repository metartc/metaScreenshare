...
public:
	...
	int32_t bgratonv12(uint8_t* src_rgba,uint8_t *dst,int32_t width,int32_t height);
	int32_t bgratoI420(uint8_t* src_rgba,uint8_t *dst,int32_t width,int32_t height);
	int32_t bgratoI4202(uint8_t* src_rgba,uint8_t *dst,int32_t width,int32_t height,int32_t stride);
	...
	int32_t nv21tonv12(uint8_t* src,uint8_t *dst,int32_t width,int32_t height);
...
private:
	...
	int (*yang_ARGBToI420)(const uint8_t* src_argb,
	               ...
	               int width,
	               int height);
	int (*yang_ABGRToI420)(const uint8_t* src_argb,
	               int src_stride_argb,
	               uint8_t* dst_y,
	               int dst_stride_y,
	               uint8_t* dst_u,
...
#define yang_YUY2ToNV12 YUY2ToNV12
	...
	#define yang_NV21ToNV12 NV21ToNV12
	...
	#define  yang_ABGRToNV12 ABGRToNV12
	#define  yang_ABGRToI420 ABGRToI420
