...
extern "C"{
#endif
            int32_t yang_thread_create(yang_thread_t* const thread, const void* attr,void* (*startfn)(void*), void* arg);
            int32_t yang_thread_join(yang_thread_t thread, void** value_ptr);
            int32_t yang_thread_mutex_init(yang_thread_mutex_t* const mutex, void* mutexattr);
            int32_t yang_thread_mutex_lock(yang_thread_mutex_t* const mutex);
            int32_t yang_thread_mutex_unlock(yang_thread_mutex_t* const mutex);
            int32_t yang_thread_mutex_destroy(yang_thread_mutex_t* const mutex);
            int32_t yang_thread_cond_destroy(yang_thread_cond_t* const condition);
            int32_t yang_thread_cond_init(yang_thread_cond_t* const condition, void* cond_attr);
            int32_t yang_thread_cond_signal(yang_thread_cond_t* const condition);
            int32_t yang_thread_cond_wait(yang_thread_cond_t* const condition,yang_thread_mutex_t* const mutex);
#ifdef __cplusplus
}
#endif
	#endif
...
int32_t yang_mutex_init(yang_thread_mutex_t* const mutex);
